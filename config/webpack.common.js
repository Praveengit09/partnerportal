...
module.exports = function (options) {
  ...
  const overrideNavbar = config.themeCustomizations && config.themeCustomizations.overrideNavbar;
  const navbarIconsPath = config.themeCustomizations && config.themeCustomizations.navbarIconsPath ? config.themeCustomizations.navbarIconsPath : '';
  ...
  return {
    ...
    plugins: [
      ...
      new CopyWebpackPlugin(
        overrideNavbar ? [{ from: 'src/assets', to: 'assets' }, { from: navbarIconsPath, to: 'assets/img' }] : [{ from: 'src/assets', to: 'assets' }],
      ...
      */
      new HtmlWebpackPlugin({
        ...
        metadata: METADATA,
        gtmKey: require(helpers.root(`src/app/base/config.js`)).Config.portal.gtmKey,
        clevertapId: require(helpers.root(`src/app/base/config.js`)).Config.portal.clevertapId,
        inject: 'body',
        xhtml: true,
        minify: isProd
          ? {
