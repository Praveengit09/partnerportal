...
export const routes = [
  ...
  { path: 'schedule', loadChildren: './schedule/schedule.module#DiagnosticScheduleModule' },
  { path: 'advice', loadChildren: './advice/diagnosticsadvice.module#DiagnosticsAdviceModule' },
  { path: 'slotbooking', loadChildren: './slotbooking/slotbooking.module#SlotBookingModule' },
  { path: 'homeorders', loadChildren: './homeorders/homeorder.module#HomeOrderModule' },
  { path: 'vdc', loadChildren: './vdc/vdcuserprivilege.module#VdcUserPrivilegeModule' },
];
