...
import { EmployeePOC } from '../../../../employee/model/employeepoc';
...
declare var nv: any;
@Component({
    selector: 'videowalkinconsultation',
    templateUrl: './videowalkinconsultation.template.html',
    styleUrls: ['./videowalkinconsultation.style.scss'],
    encapsulation: ViewEncapsulation.None
})
export class TotalRevenueOfVideoWalkinConsultation {
    nvd32Chart: any;
    nvd32Data: any;
    ...
    applyNvd3Data(): void {
        ...
        d3.select('#chart04')    //Select the <svg> element you want to render the chart in.   
