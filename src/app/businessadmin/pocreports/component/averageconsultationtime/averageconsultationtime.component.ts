...
declare var nv: any;
@Component({
    selector: 'averageconsultationtime',
    templateUrl: './averageconsultationtime.template.html',
    styleUrls: ['./averageconsultationtime.style.scss'],
    encapsulation: ViewEncapsulation.None
})
export class AverageConsultationTime {
    nvd32Chart: any;
    nvd32Data: any;
    ...
    applyNvd3Data(): void {
        ...
        if (this.reportResponse == undefined || this.reportResponse.length == 0) {
            ...
            coor.y = this.reportResponse[0].averageConsultationTime;
            ...
            for (let i = 1; i < this.reportResponse.length; i++) {
                ...
                for (let j = 0; j < num; j++) {
                    if (this.reportResponse[i].pocId == responseList[j].id) {
                        ...
                        coor.y = this.reportResponse[i].averageConsultationTime;
        ...
        d3.select('#chart10')    //Select the <svg> element you want to render the chart in.   
