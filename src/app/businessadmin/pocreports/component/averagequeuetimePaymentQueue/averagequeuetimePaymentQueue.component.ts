...
declare var nv: any;
@Component({
    selector: 'averagequeuetimePaymentQueue',
    templateUrl: './averagequeuetimePaymentQueue.template.html',
    styleUrls: ['./averagequeuetimePaymentQueue.style.scss'],
    encapsulation: ViewEncapsulation.None
})
export class AverageQueueTimePaymentQueue {
    nvd32Chart: any;
    nvd32Data: any;
    ...
    applyNvd3Data(): void {
        ...
        if (this.reportResponse == undefined || this.reportResponse.length == 0) {
            ...
            coor.y = this.reportResponse[0].averageQueueTimeForPayment;
            ...
            for (let i = 1; i < this.reportResponse.length; i++) {
                ...
                for (let j = 0; j < num; j++) {
                    if (this.reportResponse[i].pocId == responseList[j].id) {
                        ...
                        coor.y = this.reportResponse[i].averageQueueTimeForPayment;
        ...
        d3.select('#chart12')    //Select the <svg> element you want to render the chart in.   
