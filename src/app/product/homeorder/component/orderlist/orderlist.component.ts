...
import { Component, ViewEncapsulation, Renderer, ElementRef, OnInit } from '@angular/core';
...
export class OrderListComponent implements OnInit {
  ...
  constructor(config: AppConfig, renderer: Renderer, elementRef: ElementRef, private commonUtil: CommonUtil,
